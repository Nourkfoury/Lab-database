...
<html lang="en">
  ...
  <body>
    ...
    <h1 class="site-heading text-center text-white d-none d-lg-block">
      <span class="site-heading-upper ">Beauty Company</span>
        ...
        <div class="row">
          <div class="col-xl-9 mx-auto">
            <div class="cta-inner text-center rounded">
              ...
              </h2>you will feel that life changed and bacame prettier because you will feel better and more relaxed</p>
            </div>
          </div>
        </div>
      </div>
